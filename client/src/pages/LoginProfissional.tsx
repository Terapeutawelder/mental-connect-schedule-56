...
import { AlertCircle, ArrowLeft, Eye, EyeOff, Calendar, Users2 } from "lucide-react";
...
const LoginProfissional = () => {
  ...
  return (
    <div className="h-screen flex bg-gray-50">
      ...
      <div className="flex-1 flex items-center justify-center bg-white p-6 pl-[32px] pr-[32px] pt-[22px] pb-[22px] mt-[-8px] mb-[-8px] ml-[8px] mr-[8px]">
        ...
        <CardContent className="py-4">
          ...
          <div className="mt-6 pt-6 border-t">
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <span className="text-sm text-muted-foreground">Plataforma profissional</span>
            </div>
