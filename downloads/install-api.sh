...
echo "API URL: https://conexaomental.online/api"
...
echo "1. Teste a API: curl https://conexaomental.online/api/health"
echo "2. Configure SSL: certbot --nginx -d conexaomental.online"
echo "3. Teste o login no frontend: https://conexaomental.online/auth"
echo ""
